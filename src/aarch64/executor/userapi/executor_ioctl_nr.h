...
/* PAC ioctls. */
#define REVISOR_SET_PAC_KEYS_CONSTANT           11
#define REVISOR_GET_PAC_KEYS_CONSTANT           12
#define REVISOR_PAC_SIGN_CONSTANT               13
#define REVISOR_PAC_AUTH_CONSTANT               14
#define REVISOR_PAC_XPAC_CONSTANT               15
/* MTE ioctls. */
